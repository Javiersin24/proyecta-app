...
import { TopBar, Avatar, EmptyState, useIsWide } from '../../ui/kit.jsx';
        ...
        <div style={{ flex: 1, minWidth: 0, overflow: 'hidden' }}>
          {chatId ? <ChatThreadPane chatId={chatId} onBack={back} /> : (
            <div style={{ height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <EmptyState icon="chat" title="Selecciona una conversación" body="Elige un chat de la lista para ver los mensajes." />
            </div>
          )}
        </div>
      </div>
